...
def send_welcome(message):
    # अगर यूजर सामान्य रूप से /start लिखता है या पहली बार आता है
...
def admin_panel(message):
    if message.from_user.id == ADMIN_ID:
        panel_text = (
            "⚙️ **VIP बॉट एडमिन पैनल in आपका स्वागत है**\n\n"
            "यहाँ से आप अपने बॉट में प्रीमियम वीडियो अपलोड और मैनेज कर सकते हैं.\n\n"
            "👇 वीडियो सेट करने के सेट करने के लिए नीचे दिए गए बटन का उपयोग करें:"
        )
